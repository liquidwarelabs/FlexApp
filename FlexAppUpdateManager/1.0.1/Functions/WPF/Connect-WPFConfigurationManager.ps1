function Connect-WPFConfigurationManager {
    ...
    try {
        ...
        $script:WPFMainWindow.Dispatcher.Invoke([Action]{
            ...
            # Get process button (CMExportButton was moved to Package Update Edit screen)
        ...
        try {
            $script:WPFMainWindow.Dispatcher.Invoke([Action]{
                ...
                # if ($exportButton) { $exportButton.IsEnabled = $false }  # Moved to Package Update Edit screen
