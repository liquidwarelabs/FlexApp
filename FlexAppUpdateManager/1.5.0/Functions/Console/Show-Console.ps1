# Functions/Console/Show-Console.ps1
# ========================================
# Function to show the PowerShell console window
...
"@
        ...
        Write-LogMessage "Error showing console window: $($_.Exception.Message)" -Level Error
        return $false
    }
}
